...
class Board:
    ...
    def render(self):
        ...
        body += f'<footer>Generated by the <a href="https://github.com/masenf/rx-review-queue">rx-review-queue</a> skill. Only the GitHub merge box is authoritative; search qualifiers and bot summaries are not. Source data: <code>cache/runs/{esc(self.run_dir.name)}/</code>.</footer>'
